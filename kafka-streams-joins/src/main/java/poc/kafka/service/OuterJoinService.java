...
public class OuterJoinService {
	...
	private void streamStreamJoin() {
		...
		KStream<Long, CustomerOrder> joinedStream = orderStream.outerJoin(customerStream,
	...
	private Properties configs() {
		...
		configs.put("application.id", "kafka-streams-joins-outer");
